    ...
    <AuthLayout>
      <div className="text-center mb-8">
        ...
        <p className="text-zinc-400 text-sm mt-2">
          Sign in to your PrepAI account to resume your preparation.
        </p>
      </div>
      ...
      <div className="mt-8 text-center border-t border-zinc-800/80 pt-6">
        <p className="text-zinc-500 text-xs">
          New to PrepAI?{" "}
          <Link to="/signup" className="text-violet-400 hover:text-violet-300 font-semibold transition duration-150">
            Create an Account
          </Link>
        </p>
      </div>
